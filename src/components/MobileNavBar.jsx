                    ...
                    <li key={index} className="w-full">
                      <NavLink
                        ...
                        className={({ isActive, isPending }) =>
                          `flex gap-3 border-r-3 transition-colors focus-visible:outline-none focus-visible:border-white/75 cursor-pointer duration-500 text-white hover:border-white/50 capitalize ${isActive ? "border-white" : isPending ? "border-white/50" : "border-transparent"} `
                        }
                        onClick={closeNavBar}
                      >
